...
window.ecoCart.admin.ui = (function () {
    var
        ...
        loadViewDeliveryOpts = function () {
            ...
            // TODO: Edit / Remove Delivery Option
            ...
            window.ecoCart.xhr.sendRequest({
                ...
                callback: {
                    load: function (xhr) {
                        ...
                        //window.ecoCart.shared.addClassEvents("click", "delete-del", deleteCatClicked);
						//window.ecoCart.shared.addClassEvents("click", "edit-del", editCatClicked);
                    },
                    error: loadError
                }
            });
