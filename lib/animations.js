...
window.ecoCart.animations = (function () {
    var
        ...
        hideLoading = function () {
            ...
            if ((modalHider !== null) && (modalDiv !== null)) { // Make sure these elements exist before trying to remove them
        ...
        setup = function () {
            ...
            //drawLogo(document.querySelector("header#mainHeader>canvas#headerLogo"), false, 0); // Draw the ecoCart logo
            // </editor-fold>
        };
